...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/camillaucheomaenwereuzor/Desktop/RA IBL task/mouse version prova/mouse_version_ibl.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    grating = visual.GratingStim(
        ...
        ori=90.0, pos=[0,0], size=(0.5, 0.5), sf=5.0, phase=0.0,
        color=[1,1,1], colorSpace='rgb',
        opacity=None, contrast=1.0, blendmode='avg',
        texRes=128.0, interpolate=True, depth=-1.0, draggable=True)
    ...
    for thisTrial in trials:
        ...
        # Run 'Begin Routine' code from grating_pos
        import random
        start_pos = random.choice([(-0.3, 0), (0.3, 0)])
        
        grating.setPos(start_pos)
        ...
        # Run 'End Routine' code from grating_pos
        print(start_pos)
