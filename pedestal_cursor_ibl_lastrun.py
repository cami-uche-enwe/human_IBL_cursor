...
def setupData(expInfo, dataDir=None):
    ...
    thisExp = data.ExperimentHandler(
        ...
        originPath='/Users/camillaucheomaenwereuzor/Desktop/RA IBL task/mouse version prova/pedestal_cursor_ibl_lastrun.py',
...
def run(expInfo, thisExp, win, inputs, globalClock=None, thisSession=None):
    ...
    grating_l = visual.GratingStim(
        win=win, name='grating_l',
        tex='sin', mask='gauss', anchor='center',
        ori=0.0, pos=[0,0], size=(0.35, 0.35), sf=5.0, phase=1.0,
    ...
    for thisBlock in block:
        ...
        trials = data.TrialHandler(nReps=1.0, method='random', 
            extraInfo=expInfo, originPath=-1,
            trialList=data.importConditions('conditions_pedestal.xlsx'),
        ...
        for thisTrial in trials:
            ...
            # keep track of which components have finished
            trialComponents = [fixation, grating_l, grating_r, dot, mouse]
